...
<body>
    <div style="text-align: center;">
        ...
        echo "<h4>Em relação a prova 1, o aluno obteve $porProva1% do total</h4>";
        echo "<h4>Em relação a prova 2, o aluno obteve $porProva2% do total</h4>";
        echo "<h4>O aluno totalizou com as duas provas $totalAluno pontos</h4>";
        echo "<h4>A porcentagem obtida pelo aluno em função do total foi de $porTotal%</h4>";
